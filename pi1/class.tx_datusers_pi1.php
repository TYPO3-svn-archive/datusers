...
/**
 * Plugin 'Login' for the 'datusers' extension.
 *
 ...
 *
 *
 *   68: class tx_datusers_pi1 extends tslib_pibase
 *
 ...
 *
 */
class tx_datusers_pi1 extends tslib_pibase
{
  ...
  * @var string
  */
  public $prefixId  = 'tx_datusers_pi1';
...
0  * Path to this script relative to the extension directory
  ...
  * @var string
  */
  public $scriptRelPath  = 'pi1/class.tx_datusers_pi1.php';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/datusers/pi1/class.tx_datusers_pi1.php'])
{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/datusers/pi1/class.tx_datusers_pi1.php']);
}
